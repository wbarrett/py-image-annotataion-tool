...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        if self.ann:
            ret = QMessageBox.question(self, "Exit application", "Save all (annotation list + unsaved masks) before exit?", QMessageBox.Yes | QMessageBox.No | QMessageBox.Cancel)
    ...
    def helpAbout(self):        
        QMessageBox.about(self, "About XRanT",
                "<b>XRanT: X-Ray Annotation Tool</b><br>"
                "Author: Muhammet Bastan<br>IUPR @TU-KL<br>mubastan@iupr.com<br>July 2011")
